<?php
function DisplayMasterTableInfo_customer_header($params)
{
	$keys = $params["keys"];
	...
	$layout = GetPageLayout("customer_header", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("customer_header", "masterlist"));
}
