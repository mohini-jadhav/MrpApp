...
class facebookWrapper {
	...
	function FBgetLoginUrl($params = array()) {
		...
		return $this->fbObj->getLoginUrl ( array (
				'display' => 'popup',
				'redirect_uri' => $url 
		) );
	}
...
function SupposeImageType($file) {
	...
	if (strlen ( $file ) > 3 && ord ( $file [0] ) == 0xff && ord ( $file [1] ) == 0xd8 && ord ( $file [2] ) == 0xff)
		return "image/jpeg";
	if (strlen ( $file ) > 8 && ord ( $file [0] ) == 0x89 && ord ( $file [1] ) == 0x50 && ord ( $file [2] ) == 0x4e && ord ( $file [3] ) == 0x47 && ord ( $file [4] ) == 0x0d && ord ( $file [5] ) == 0x0a && ord ( $file [6] ) == 0x1a && ord ( $file [7] ) == 0x0a)
		return "image/png";
}
...
function CustomExpression($value, $data, $field, $ptype, $table = "") {
	...
	if (! $table)
		$table = $strTableName;
	if ($table == "customer_header" && $field == "Temperature") {
		if (strpos ( $value, 'Red' ) !== FALSE) {
			$color = "red";
			
			$value = '<strong>' . $value . '</strong> ';
		} else if (strpos ( $value, 'Yellow' ) !== FALSE) {
			$color = "Yellow";
			$value = '<strong>' . $value . '</strong> ';
		} else if (strpos ( $value, 'Green' ) !== FALSE) {
			$color = "green";
			$value = '<strong>' . $value . '</strong> ';
		} else if (strpos ( $value, 'Black' ) !== FALSE) {
			$color = "Black";
		} else {
			$color = "Blue";
		}
	...
	if ($table == "customer_header" && $field == "Overall_Temp" && $ptype == "view") {
		if (strpos ( $value, 'Red' ) !== FALSE) {
			$color = "red";
	...
	if ($table == "customer_header" && $field == "Overall_Temp" && $ptype == "list") {
		if (strpos ( $value, 'Red' ) !== FALSE) {
			$color = "red";
	...
	if ($table == "customer_header" && $field == "Overall_Temp" && $ptype == "print") {
		if (strpos ( $value, 'Red' ) !== FALSE) {
			$color = "red";
	...
	if ($table == "customer_header" && $field == "Overall_Temp" && $ptype == "export") {
		if (strpos ( $value, 'Red' ) !== FALSE) {
			$color = "red";
	...
	if ($table == "customer_header" && $field == "Overall_Temp" && $ptype == "masterprint") {
		if (strpos ( $value, 'Red' ) !== FALSE) {
			$color = "red";
	...
	if ($table == "employee_header" && $field == "EmployeeStatus" && $ptype == "view") {
		if (strpos ( $value, 'Terminated' ) !== FALSE) {
			$color = "White";
	...
	if ($table == "employee_header" && $field == "EmployeeStatus" && $ptype == "list") {
	...
	if ($table == "employee_header" && $field == "EmployeeStatus" && $ptype == "print") {
		if (strpos ( $value, 'Terminated' ) !== FALSE) {
			$color = "White";
	...
	if ($table == "employee_header" && $field == "EmployeeStatus" && $ptype == "export") {
		if (strpos ( $value, 'Terminated' ) !== FALSE) {
			$color = "White";
	...
	if ($table == "time" && $field == "EmployeeStatus" && $ptype == "view") {
		if (strpos ( $value, 'No' ) !== FALSE) {
			$color = "Black";
	...
	if ($table == "time" && $field == "EmployeeStatus" && $ptype == "list") {
		if (strpos ( $value, 'No' ) !== FALSE) {
			$color = "White";
	...
	if ($table == "time" && $field == "EmployeeStatus" && $ptype == "print") {
		if (strpos ( $value, 'No' ) !== FALSE) {
			$color = "White";
	...
	if ($table == "time" && $field == "EmployeeStatus" && $ptype == "export") {
		if (strpos ( $value, 'No' ) !== FALSE) {
			$color = "White";
	...
	if ($table == "emptime" && $field == "EmployeeStatus") {
		if (strpos ( $value, 'No' ) !== FALSE) {
			$color = "White";
...
function GetLWWhere($field, $ptype, $table = "") {
	...
	if (! $table)
		$table = $strTableName;
	if ($table == "customer_header" && $field == "TAM") {
		return " Role like 'TAM%' ";
	}
	if ($table == "customerallocation" && $field == "CustomerName" && $ptype == "add") {
		return "Engagement_Status like 'Act%' ";
	}
	if ($table == "customerallocation1" && $field == "CustomerName" && $ptype == "add") {
		return "Engagement_Status like 'Act%' ";
	}
	return "";
}
...
function GetDefaultValue($field, $ptype, $table = "") {
	...
	if (! $table)
		$table = $strTableName;
	if ($table == "customer_header" && $field == "Engagement_status" && $ptype == "edit") {
		return "Active";
	}
	if ($table == "customer_header" && $field == "Engagement_status" && $ptype == "register") {
		return "Active";
	}
	if ($table == "customer_header" && $field == "Engagement_status" && $ptype == "add") {
		return "Active";
	}
	if ($table == "customer_header" && $field == "Engagement_status" && $ptype == "search") {
		return "Active";
	}
	if ($table == "customer_header" && $field == "created_by" && $ptype == "edit") {
		return $_SESSION ["UserID"];
	}
	if ($table == "customer_header" && $field == "created_by" && $ptype == "register") {
		return $_SESSION ["UserID"];
	}
	if ($table == "customer_header" && $field == "created_by" && $ptype == "add") {
		return $_SESSION ["UserID"];
	}
	if ($table == "customer_header" && $field == "created_by" && $ptype == "search") {
		return $_SESSION ["UserID"];
	}
	if ($table == "customer_header" && $field == "Created_date" && $ptype == "edit") {
		return Now ();
	}
	if ($table == "customer_header" && $field == "Created_date" && $ptype == "register") {
		return Now ();
	}
	if ($table == "customer_header" && $field == "Created_date" && $ptype == "add") {
		return Now ();
	}
	if ($table == "customer_header" && $field == "Created_date" && $ptype == "search") {
		return Now ();
	}
	if ($table == "customer_header" && $field == "Updated_by" && $ptype == "edit") {
		return $_SESSION ["UserID"];
	}
	if ($table == "customer_header" && $field == "Updated_by" && $ptype == "register") {
		return $_SESSION ["UserID"];
	}
	if ($table == "customer_header" && $field == "Updated_by" && $ptype == "add") {
		return $_SESSION ["UserID"];
	}
	if ($table == "customer_header" && $field == "Updated_by" && $ptype == "search") {
		return $_SESSION ["UserID"];
	}
	if ($table == "customer_header" && $field == "Updated_date" && $ptype == "edit") {
		return Now ();
	}
	if ($table == "customer_header" && $field == "Updated_date" && $ptype == "register") {
		return Now ();
	}
	if ($table == "customer_header" && $field == "Updated_date" && $ptype == "add") {
		return now ();
	}
	if ($table == "customer_header" && $field == "Updated_date" && $ptype == "search") {
		return Now ();
	}
	if ($table == "customer_header" && $field == "Stage" && $ptype == "edit") {
		return 2;
	}
	if ($table == "customer_header" && $field == "Stage" && $ptype == "register") {
		return 2;
	}
	if ($table == "customer_header" && $field == "Stage" && $ptype == "add") {
		return "Transition";
	}
	if ($table == "customer_header" && $field == "Overall_Temp" && $ptype == "edit") {
		return "Green";
	}
	if ($table == "customer_header" && $field == "Overall_Temp" && $ptype == "register") {
		return "Green";
	}
	if ($table == "customer_header" && $field == "Overall_Temp" && $ptype == "add") {
		return "Green";
	}
	if ($table == "employee_header" && $field == "emailID" && $ptype == "edit") {
		return "@sungardas.com";
	}
	if ($table == "employee_header" && $field == "emailID" && $ptype == "register") {
		return "@sungardas.com";
	}
	if ($table == "employee_header" && $field == "emailID" && $ptype == "add") {
		return "@sungardas.com";
	}
	if ($table == "employee_header" && $field == "Type") {
		return "No";
	}
	if ($table == "employee_header" && $field == "SupervisorTitle" && $ptype == "edit") {
		return "No";
	}
	if ($table == "employee_header" && $field == "SupervisorTitle" && $ptype == "register") {
		return "No";
	}
	if ($table == "employee_header" && $field == "SupervisorTitle" && $ptype == "add") {
		return "No";
	}
	if ($table == "employee_header" && $field == "created_by" && $ptype == "add") {
		return $_SESSION ["UserID"];
	}
	if ($table == "employee_header" && $field == "updated_by" && $ptype == "edit") {
		return $_SESSION ["UserID"];
	}
	if ($table == "employee_header" && $field == "updated_by" && $ptype == "register") {
		return $_SESSION ["UserID"];
	}
	if ($table == "employee_header" && $field == "updated_by" && $ptype == "add") {
		return $_SESSION ["UserID"];
	}
	if ($table == "employee_header" && $field == "updated_by" && $ptype == "search") {
		return $_SESSION ["UserID"];
	}
	if ($table == "employee_header" && $field == "created_date" && $ptype == "add") {
		return now ();
	}
	if ($table == "employee_header" && $field == "EmployeeStatus" && $ptype == "register") {
		return Active;
	}
	if ($table == "employee_header" && $field == "EmployeeStatus" && $ptype == "add") {
		return "Yes";
	}
	if ($table == "customerallocation" && $field == "StartDate" && $ptype == "search") {
		return strftime ( "%Y-%m-%d" );
	}
	if ($table == "customerallocation" && $field == "EndDate" && $ptype == "edit") {
		return strftime ( "%Y-%m-%d" );
	}
	if ($table == "customerallocation" && $field == "EndDate" && $ptype == "register") {
		return strftime ( "%Y-%m-%d" );
	}
	if ($table == "customerallocation" && $field == "EndDate" && $ptype == "search") {
		return strftime ( "%Y-%m-%d" );
	}
	if ($table == "Workload" && $field == "StartDate" && $ptype == "search") {
		return strftime ( "%Y-%m-%d" );
	}
	if ($table == "Workload" && $field == "EndDate" && $ptype == "search") {
		return strftime ( "%Y-%m-%d" );
	}
	if ($table == "customerallocation1" && $field == "StartDate" && $ptype == "search") {
		return strftime ( "%Y-%m-%d" );
	}
	if ($table == "customerallocation1" && $field == "EndDate" && $ptype == "edit") {
		return strftime ( "%Y-%m-%d" );
	}
	if ($table == "customerallocation1" && $field == "EndDate" && $ptype == "register") {
		return strftime ( "%Y-%m-%d" );
	}
	if ($table == "customerallocation1" && $field == "EndDate" && $ptype == "search") {
		return strftime ( "%Y-%m-%d" );
	}
	return "";
}
...
function xtempl_include_header($xt, $fname, $param) {
	$xt->assign_function ( $fname, "xt_include", array (
			"file" => $param 
	) );
}
 ...
 * @return Mixed Todo: It should return QueryResult object //#9875
 *         @intellisense
 */
/*
...
function runner_mail_smtp($params) {
	...
	if ("1" == "1" && "peter.stewart" != "" || isset ( $params ['username'] )) {
		$mail->SMTPAuth = true; // enable SMTP authentication
		$mail->Username = isset ( $params ['username'] ) ? $params ['username'] : "peter.stewart"; // SMTP username
		$mail->Password = isset ( $params ['password'] ) ? $params ['password'] : "lockdown1"; // SMTP password
	} else {
		$mail->SMTPAuth = false;
	}
	if ("1" == "1" && "192.168.167.26" != "" || isset ( $params ['host'] )) {
		$mail->Host = isset ( $params ['host'] ) ? $params ['host'] : "192.168.167.26"; // sets SMTP server
	} else if (ini_get ( 'SMTP' ) != '')
		$mail->Host = ini_get ( 'SMTP' );
	
	if ("1" == "1" && "25" != "" || isset ( $params ['port'] ))
	...
	if (isset ( $params ['attachments'] ) && is_array ( $params ['attachments'] )) {
		foreach ( $params ['attachments'] as $attachment ) {
			$mail->AddAttachment ( $attachment ['path'], isset ( $attachment ['name'] ) ? $attachment ['name'] : '', isset ( $attachment ["encoding"] ) ? $attachment ["encoding"] : 'base64', isset ( $attachment ["type"] ) ? $attachment ["type"] : 'application/octet-stream' );
		}
	}
...
function imageCreateThumb($new_width, $new_height, $img_width, $img_height, $file_path, $options, $new_file_path, $uploadedFile) {
	...
	switch (strtolower ( substr ( strrchr ( $file_path, '.' ), 1 ) )) {
		...
		case 'jpeg' :
			...
			$success = @imagecopyresampled ( $new_img, $src_img, 0, 0, 0, 0, $new_width, $new_height, $img_width, $img_height ) && imagejpeg ( $new_img, $new_file_path, $image_quality );
			break;
		case 'gif' :
			@imagecolortransparent ( $new_img, @imagecolorallocate ( $new_img, 0, 0, 0 ) );
			$src_img = @imagecreatefromgif ( $file_path );
			$image_quality = null;
			$success = @imagecopyresampled ( $new_img, $src_img, 0, 0, 0, 0, $new_width, $new_height, $img_width, $img_height ) && imagegif ( $new_img, $new_file_path, $image_quality );
			break;
		case 'png' :
			@imagecolortransparent ( $new_img, @imagecolorallocate ( $new_img, 0, 0, 0 ) );
			...
			$success = @imagecopyresampled ( $new_img, $src_img, 0, 0, 0, 0, $new_width, $new_height, $img_width, $img_height ) && imagepng ( $new_img, $new_file_path, $image_quality );
			break;
		default :
			$src_img = null;
			$success = false;
...
function upcount_name($name) {
	return preg_replace_callback ( '/(?:(?: \(([\d]+)\))?(\.[^.]+))?$/', 'upcount_name_callback', $name, 1 );
}
 ...
 * GDExist
 * Fake function.
 * Only matter something for ASP, because in PHP GD always exist (since 4.3.0)
 * @intellisense
 */
function GDExist() {
	return true;
...
/**
 * GetTableLink
 * Form proper link for table.
 * Really need for ASP.Net MVC
 * 
 * @param
 *        	{string} Table name
 * @param
...
function json_mb_encode_numericentity(&$item, $key) {
	if (is_string ( $item ))
		$item = runner_encode_numeric_entity ( $item, array (
				0x80,
				0xffff,
				0,
				0xffff 
...
function getHTMLEntityData($encodedEntity) {
	...
	return array (
			"isHTMLEntity" => true,
			"entityLength" => runner_strlen ( $entity ) 
	);
}
